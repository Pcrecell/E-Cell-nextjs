...
// Deterministic tech nodes data - this will be the same on server and client
const techNodesData = [
  { size: 4, x: 15, y: 25, color: "#007BFF" },
  { size: 3, x: 75, y: 45, color: "#FF69B4" },
  { size: 5, x: 35, y: 65, color: "#007BFF" },
  { size: 2, x: 85, y: 15, color: "#FF69B4" },
  { size: 4, x: 25, y: 85, color: "#007BFF" },
  { size: 3, x: 65, y: 25, color: "#FF69B4" },
  { size: 5, x: 45, y: 75, color: "#007BFF" },
  { size: 2, x: 90, y: 55, color: "#FF69B4" },
  { size: 4, x: 20, y: 35, color: "#007BFF" },
  { size: 3, x: 70, y: 80, color: "#FF69B4" },
  { size: 2, x: 55, y: 20, color: "#007BFF" },
  { size: 4, x: 30, y: 60, color: "#FF69B4" },
  { size: 3, x: 80, y: 40, color: "#007BFF" },
  { size: 5, x: 10, y: 70, color: "#FF69B4" },
  { size: 2, x: 60, y: 90, color: "#007BFF" },
]
...
const StaticTechBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Tech nodes with deterministic positioning */}
      <div className="absolute inset-0">
        {techNodesData.map((node, i) => (
          <div
            key={`node-${i}`}
        ...
        <div className="relative">
          <div className="flex justify-center items-center">
            ...
            <div className="overflow-hidden w-full">
              <motion.div
                className="flex justify-center items-center py-10 cursor-grab active:cursor-grabbing"
                drag="x"
                dragConstraints={{ left: 0, right: 0 }}
                onDragEnd={(event, info) => {
                  const threshold = 80; // px to trigger a slide
