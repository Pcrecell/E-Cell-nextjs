...
import { trusted_by_companies } from "../../../../public/images/image-links";
...
const TrustedByCompaniesApp = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full sm:w-[35%] flex justify-center overflow-hidden bg-gradient-to-b relative">
        {/* Top fade */}
        <div className="absolute top-0 left-0 w-full h-24 z-30 pointer-events-none bg-gradient-to-b from-black to-transparent" />
        {/* Bottom fade */}
        <div className="absolute bottom-0 left-0 w-full h-24 z-30 pointer-events-none bg-gradient-to-t from-black to-transparent" />
        <Carousel
          images={images}
          displayTime={1200}
          transitionTime={300}
