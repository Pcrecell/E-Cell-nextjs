...
}, [currentIndex, displayTime, images.length, shouldAnimate]);
...
>
  <img
    src={image.link}
    alt={image.alt}
    className="max-w-72 max-h-72 sm:max-w-64 sm:max-h-80 xl:max-w-[28rem] xl:max-h-[28rem] overflow-visible"
  />
</motion.div>
