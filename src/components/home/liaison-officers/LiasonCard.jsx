...
import "./LiasonCard.css";
import { liaison_officers } from "../../../../public/images/image-links";
...
const ProfileCardComponent = ({
  ...
  }, []); // Empty dependency array since we don't need to re-run this
  ...
  const cardStyle = useMemo(() => ({
    "--icon": isCardVisible && iconUrl ? `url(${iconUrl})` : "none",
    "--grain": isCardVisible && grainUrl ? `url(${grainUrl})` : "none",
    "--behind-gradient": showBehindGradient ? (behindGradient ?? DEFAULT_BEHIND_GRADIENT) : "none",
    "--inner-gradient": innerGradient ?? DEFAULT_INNER_GRADIENT,
  }), [isCardVisible, iconUrl, grainUrl, showBehindGradient, behindGradient, innerGradient]);
