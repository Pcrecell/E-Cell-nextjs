...
const eventPaths = {
  ...
  'esummit': 'gallery/esummit',
  'build-school': 'gallery/build-school',
  'maverick': 'gallery/maverick',
  'i-camp': 'gallery/i-camp',
  'ecell-life': 'gallery/life-at-ecell',
};
  ...
  return (
    <div className="relative min-h-[90vh] w-full bg-[black] overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[90vh]">
        ...
        <div className="relative grid grid-cols-12 grid-rows-[repeat(22,_minmax(0,_1fr))] gap-2 sm:gap-3 sm:w-full md:w-[75%] h-[1100px] md:h-[2200px] bg-none p-2 rounded-lg">
