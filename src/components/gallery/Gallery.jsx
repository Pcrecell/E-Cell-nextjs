...
const images = [
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/Life-at-ecell-cropped.webp?updatedAt=1755114120255',
    content: 'Life at E-Cell',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/D24-0028-album-cover.webp?updatedAt=1755114120106',
    content: 'Mavericks 2025',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/ADI-2300-2.webp?updatedAt=1755114120101',
    content: 'I Camp',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/D24-0038-album-cover.webp?updatedAt=1755114120134',
    content: 'Mavericks 2025',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/DSC06444-album-cover.webp?updatedAt=1755114120047',
  ...
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/DSC0322-1-album-cover.webp?updatedAt=1755114120166',
    content: 'Flash Mob',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/Life-at-ecell-cropped.webp?updatedAt=1755114120255',
  ...
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/DSC04639-album-potential.webp?updatedAt=1755114119973',
    content: 'Hult Prize 2024',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/DSC08728-1.webp?updatedAt=1755114119962',
    content: 'E-Summit 2022',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/1748849096-gbm-crpped-album-cover.webp?updatedAt=1755114120161',
  ...
  {
    image:
      'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/1748849096-gbm-crpped-album-cover.webp?updatedAt=1755114120161',
    content: 'General Body Meeting',
  },
  {
    image: 'https://ik.imagekit.io/ecellkiit/E-Cell%20Website/D24-0028-album-cover.webp?updatedAt=1755114120106',
  ...
  return (
    <div>
      <div className="relative min-h-[60vh] bg-[black] overflow-hidden">
        ...
        {/* Main content */}
        <div className="relative z-10 px-4 flex items-center justify-center min-h-[85vh] sm:min-h-screen translate-y-36 mb-36 md:mb-0 md:translate-y-0">
          <div className="absolute px-10 text-white top-0 max-w-screen-xl w-full flex flex-col md:translate-x-17 md:flex-row items-center justify-start gap-6 md:relative md:px-0 lg:relative lg:px-0">
            ...
            <div className="text-center mb-8 md:mb-0 md:translate-x-[7vw] md:text-left">
              <div
                className={`font-['Milker'] text-4xl mt-[-40px] md:text-5xl font-bold mb-2 md:mb-4 tracking-wider ${Milker.className}`}
                style={{ fontFamily: 'var(--font-milker), sans-serif' }}
              >
                <p className="font-[Milker]">
            ...
            <div className="transform -translate-x-[5vh] scale-[1.1] md:scale-[0.7] md:translate-x-[0] lg:translate-x-[0]">
                ...
                {images.map((img, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={`absolute top-1/2 left-1/2 transition-all duration-\[3000ms\] ease-in-out ${
      ...
      <div className="relative bg-[black] overflow-hidden">
        ...
        <div className="relative z-10  md:mb-24">
          <div>
            <h1 className="text-5xl md:text-[5rem] tracking-wider text-center w-full font-[Transcity] text-white mb-8 md:mb-10 md:mt-12">
