  ...
  return (
    <div className="relative mt-16 px-2 sm:px-3">
      <div className="relative w-full rounded-t-[80px] sm:rounded-t-[140px] border border-white overflow-hidden bg-black p-[2px] sm:p-[3px] h-[300px] sm:h-[calc(100vh-40px)] flex items-center justify-center">
        {/* Responsive Image */}
        <img
          src="https://ik.imagekit.io/piyush01/mevrik?updatedAt=1752735684131"
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 my-16 px-4 items-start">
      ...
      <div className="flex flex-col items-center text-center space-y-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          <p className="text-[#FE5A1F] text-3xl sm:text-5xl font-bold tracking-wide">
            KIIT E-CELL
          </p>
          <p className="text-[#FE5A1F] text-2xl sm:text-3xl font-semibold">
            presents
          </p>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <p className="font-extrabold text-white flex items-end justify-center">
              ...
              <span
                className={`text-[#FE5A1F] ml-2 leading-none ${current.plusSize}`}
              >
                +
              </span>
            </p>
      ...
      <div className="flex justify-center items-center">
       <img
          src="https://i.postimg.cc/Zn5JFfTR/Whats-App-Image-2025-07-09-at-00-26-43-39581389-removebg-preview.png"
          alt="ICAMP"
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        <div className="flex flex-row gap-4 w-full">
          <div className="w-1/2 overflow-hidden rounded-xl">
            <img
              src="https://ik.imagekit.io/d73k0qzwc/D24_0036%201.png"
          ...
          <div className="w-1/2 overflow-hidden rounded-xl">
            <img
              src="https://ik.imagekit.io/d73k0qzwc/DSC_0191%201.png"
        ...
        <p className="text-white text-sm sm:text-base text-left leading-relaxed max-w-[700px] mt-1">
          Maverick is a unique initiative by KIIT E-Cell that encourages
          entrepreneurial exploration and creative problem-solving. It is
          designed to inspire students to think independently, tackle real-world
          challenges, and develop practical skills that support their journey as
          future innovators and leaders.{" "}
        </p>{" "}
        <a
          href="/maverick"
          className="bg-[#FE5A1F] hover:bg-[#FE5A1F] text-white px-6 sm:px-8 py-3 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-colors flex items-center justify-center text-center"
          tabIndex={0}
  ...
  return (
    <div className="flex flex-col lg:flex-row my-12 w-full">
      ...
      <div className="w-full lg:w-[70%] h-[400px] lg:h-[500px]">
        <img
          src="https://ik.imagekit.io/d73k0qzwc/DSC_0202%20(2)%201.png"
          alt="Auditorium"
      ...
      <div className="w-full lg:w-[30%] bg-black bg-opacity-80 p-8 lg:p-12 flex flex-col justify-center">
        <div className="text-white text-left">
          <p className="text-gray-300 text-lg leading-relaxed mb-6">
            Maverick brings together students, professionals and mentors through
            a curated mix of workshops, interactive sessions and
            community-driven engagements. It fosters a culture of collaboration
            and innovation. The initiative nurtures curiosity, critical thinking
            and the drive to build meaningful solutions.{" "}
          </p>
          ...
          <div className="mb-2">
            ...
            <span className="text-[#fe5a1f] text-4xl lg:text-[100px] font-bold ml-1">
              +
            </span>
          </div>
    ...
    <div className="my-12 px-4">
      ...
      <div className="hidden lg:flex gap-4">
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/DSC_0180%201.png"
            alt="Team"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/D24_0108%202.png"
            alt="Awards Ceremony"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/D24_0108%203.png"
