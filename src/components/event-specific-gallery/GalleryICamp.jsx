  ...
  return (
    <div className="relative mt-16 px-2 sm:px-3">
      <div className="relative w-full rounded-t-[80px] sm:rounded-t-[140px] border border-white overflow-hidden bg-black p-[2px] sm:p-[3px] h-[300px] sm:h-[calc(100vh-40px)] flex items-center justify-center">
        {/* Responsive Image */}
        <img
          src="https://ik.imagekit.io/piyush01/WhatsApp%20Image%202025-07-17%20at%2012.24.53%20PM.jpeg?updatedAt=1752735324991"
          alt="I-CAMP Panel Discussion"
...
const StatsSection = ({ mode, onHoverChange, selectedMode, onModeSelect }) => {
  const statsData = {
    ...
    alt: {
      ...
      plusSize: "text-[60px]",
      mainSize: "text-[100px]",
      label: "COMPANIES NETWORKED WITH",
    },
  };
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 my-16 px-4 items-start">
      ...
      <div className="flex flex-col items-center text-center space-y-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          <p className="text-[#37ADDC] text-3xl sm:text-5xl font-bold tracking-wide">
            KIIT E-CELL
          </p>
          <p className="text-[#37ADDC] text-2xl sm:text-3xl font-semibold">
            presents
          </p>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <p className="font-extrabold text-white flex items-end justify-center">
              ...
              <span className={`text-[#37ADDC] ml-2 leading-none ${current.plusSize}`}>+</span>
            </p>
      ...
      {/* Center Blue Icamp Block */}
      <div className="flex justify-center items-center">
        {/* <div className="absolute inset-0 bg-gradient-to-br from-black via-transparent to-black opacity-40 rounded-2xl z-0"></div> */}
        <img
          src="https://ik.imagekit.io/d73k0qzwc/Group%208.png"
          alt="ICAMP"
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        <div className="flex flex-row gap-4 w-full">
          <div className="w-1/2 overflow-hidden rounded-xl">
            <img
              src="https://ik.imagekit.io/d73k0qzwc/_MG_3587%201.png"
          ...
          <div className="w-1/2 overflow-hidden rounded-xl">
            <img
              src="https://ik.imagekit.io/d73k0qzwc/Frame%201618873029.png"
        ...
        <p className="text-white text-sm sm:text-base text-left leading-relaxed max-w-[700px] mt-1">
          I-Camp is KIIT E-Cell’s internship-driven initiative that bridges the gap between students and the professional world. It provides curated exposure to real industry environments, helping students understand corporate expectations and take their first confident step toward career readiness.        </p>
        <a
          href="/i-camp"
          className="bg-[#37ADDC] hover:bg-[#0C67D2] text-white px-6 sm:px-8 py-3 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-colors flex items-center justify-center text-center"
          tabIndex={0}
  ...
  return (
    <div className="flex flex-col lg:flex-row my-12 w-full">
      ...
      <div className="w-full lg:w-[70%] h-[400px] lg:h-[500px]">
        <img
          src="https://ik.imagekit.io/d73k0qzwc/ADI_2825%202.png"
          alt="Auditorium"
...
Through mock interviews and internship opportunities with reputed organizations, I-Camp prepares students to navigate the job market with clarity and confidence. The event focuses on building essential skills such as communication, professionalism and adaptability while offering insights into the expectations and culture of today’s workplaces.          </p>

          <div className="mb-2">
            <span className="text-white text-6xl lg:text-[150px] font-bold">15</span>
            <span className="text-[#37ADDC] text-4xl lg:text-[100px] font-bold ml-1">+</span>
          </div>
    ...
    <div className="my-12 px-4">
      ...
      <div className="hidden lg:flex gap-4">
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/ADI_2604%204.png"
            alt="Team"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/ADI_2346%20(1)%202.png"
            alt="Awards Ceremony"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="flex-1 h-[450px] overflow-hidden">
          <img
            src="https://ik.imagekit.io/d73k0qzwc/ADI_2346%20(1)%203.png"
