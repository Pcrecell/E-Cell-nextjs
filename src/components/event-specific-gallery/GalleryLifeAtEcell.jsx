...
const HeroSection = ({ onHoverChange }) => {
  return (
    <div className="relative mt-16 px-2 sm:px-3">
      <div className="relative w-full rounded-t-[80px] sm:rounded-t-[140px] border border-white bg-black p-[2px] sm:p-[3px] h-[300px] sm:h-[calc(100vh-40px)] flex items-center justify-center overflow-hidden">
        {/* Responsive Image */}
        <img
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 my-16 px-4 items-start">
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <a
          href="/"
          className="text-white px-6 sm:px-8 py-3 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-colors flex items-center justify-center text-center"
          style={{ background: '#37ADDC', display: 'inline-block' }}
          tabIndex={0}
        >
          CHECK OUR WEBSITE
        </a>
