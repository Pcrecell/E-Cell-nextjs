...
const ResponsiveArrow = ({ activeEvent, activeIndex, className, topOffset, calculationFn }) => (
  ...
  >
    <a href={activeEvent.link} className="w-[23px] h-[17px] block">
      <ArrowSVG />
    </a>
  </motion.div>
);
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-2 pt-4 sm:px-12 lg:px-24 xl:px-44">
        <AnimatePresence mode="wait">
          <motion.h1
            ...
            className={`font-transcity text-7xl sm:text-6xl md:text-6xl lg:text-7xl xl:text-[115px] font-normal leading-tight bg-clip-text text-white mb-4 sm:mb-4 ${Transcity.className}`}
