...
const Anton = AntonFont({ subsets: ["latin"], weight: "400" });
    ...
    <div className="min-h-auto bg-black flex flex-col lg:flex-row pt-4 sm:pt-6 lg:pt-10">
      ...
      <div className="hidden lg:flex w-40 xl:w-48 bg-black items-center justify-center relative">
        <div className="flex items-center justify-center h-full">
          {/* Vertical Text */}
          <div
            className={`text-6xl sm:text-7xl md:text-[80px] xl:text-[100px] font-bold text-transparent bg-gradient-to-b from-[#222] to-gray-300 bg-clip-text tracking-wider ${Anton.className}`}
            style={{
          ...
          <div className="relative z-10 p-4 sm:p-8 md:p-12 lg:p-16 lg:pl-20 xl:pl-80 min-h-screen lg:min-h-auto flex flex-col justify-center">
            ...
            <div className="mb-12 sm:mb-16 lg:mb-20">
              ...
              <p className="text-white font-['Poppins'] text-sm sm:text-m lg:text-xl leading-relaxed max-w-full lg:max-w-2xl text-justify opacity-90 px-2 sm:px-0">
                The KIIT Entrepreneurship Cell (KIIT E-Cell) is the official
                student-driven body at Kalinga Institute of Industrial
                Technology (KIIT), dedicated to fostering a culture of
                innovation, creativity, and entrepreneurship among students. It
                serves as a dynamic platform where aspiring entrepreneurs are
                nurtured through hands-on exposure, mentorship from industry
                leaders, interactive workshops, and real-world startup
                experiences. With a mission to transform ideas into viable
                ventures, KIIT E-Cell regularly organizes flagship events like
                E-Summit, startup bootcamps, and pitch competitions, drawing
                participation from across India. Backed by a vibrant ecosystem
                of innovators, mentors, and investors, KIIT E-Cell strives to
                empower students to think independently, act boldly, and lead
                purposefully in shaping the future of entrepreneurship.
              </p>
            </div>
          </div>
        </div>
