...
import {about_page} from "../../../public/images/image-links"

// AboutUsTopSection: Full-screen scrollable sections for KIIT, KISS, and Founder
const AboutUsTopSection = () => {
  return (
    <div className="w-full min-h-auto text-white overflow-x-hidden">
      {/* KIIT Section */}
      <section className="w-full min-h-[70vh] sm:min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-black via-gray-900 to-black relative pt-4 sm:pt-8 md:pt-16 px-2 sm:px-4 md:px-8">
        <div
        ...
        >
          <img
            src={about_page.hero_bg.link}
            alt={about_page.hero_bg.alt}
            loading={about_page.hero_bg.loading}
        ...
        <div className="relative max-w-2xl w-full flex flex-col items-center mt-0 md:mt-16">
          <div
            className="absolute top-0 left-0 z-40 w-10 h-10 md:w-auto md:h-auto flex items-center justify-center"
            style={{ padding: 0, margin: 0 }}
          >
            <span className="text-5xl md:text-9xl text-white font-bold font-transcity w-full h-full translate-y-5">
              “
            </span>
          </div>
          <div
            className="w-full rounded-xl min-h-[120px] sm:min-h-[180px] md:min-h-[260px] md:max-w-3xl md:translate-y-1.2 sm:max-w-4xl p-4 sm:p-8 pt-10 sm:pt-16 text-center relative z-20 top-10"
            style={{
              background: "linear-gradient(180deg, #1E1E1E 0%, #424141 80%)",
            }}
          >
            <h1 className="text-5xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6 tracking-wide">
              KIIT
            </h1>
            <p className="text-xs sm:text-lg md:text-2xl leading-relaxed px-2 tracking-wider sm:px-0">
      ...
      <section className="w-full min-h-auto flex flex-col justify-between py-0 bg-gradient-to-b from-black via-gray-900 to-black relative">
          ...
          >
            ...
            >
              <div className="w-full h-full flex flex-col justify-center px-2 sm:px-8 py-2 sm:py-7">
                <p
                  className="text-xs font-roboto sm:text-base tracking-wider md:text-2xl leading-normal text-white font-normal px-1 py-3 sm:py-0 sm:px-0"
            ...
            <div
              className="w-full sm:w-[40%] flex items-end justify-end mb-2 sm:mb-0 order-1 sm:order-2"
              style={{ zIndex: 2, justifyContent: "end" }}
            >
              <img
                src={"https://ik.imagekit.io/ilgcom35w/about-us-kiss-bg-improved.png?updatedAt=1754506548295"}
                alt="KISS Building"
      ...
      {/* Founder Section */}
      <section className="w-full min-h-auto flex flex-col justify-center items-center md:pr-0 sm:py-12 bg-gradient-to-b from-black via-gray-900 to-black md:pt-[10%]">
        ...
        <div className="flex flex-col sm:flex-row items-end justify-end gap-2 sm:gap-8 w-full">
          <div className="w-full sm:w-[40%] flex justify-start mb-2 sm:mb-0 pr-0 flex-col items-start">
            <img
              src={"https://ik.imagekit.io/ilgcom35w/about-us-founder-bg-improved.png?updatedAt=1754506408057"}
              alt="Founder Speech"
            ...
            >
              <div className="">
                <p
                  className="text-[10px] text-right sm:text-base max-w-[85%] md:text-m lg:m text-white font-normal leading-snug"
                ...
                <p
                  className="text-[10px] text-end pr-16 md:pr-26 lg:pr-24 sm:text-base md:text-m lg:text-xl font-normal mt-2"
                  style={{
                    color: "#1a78ae",
          ...
          >
            <div className="w-full h-full flex flex-col justify-center pl-1 sm:pl-8 pr-0 py-7 sm:py-7">
              <p
                className="text-xs font-roboto sm:text-base md:text-2xl tracking-wide text-white font-normal px-4 sm:px-0"
