          ...
          <div className="relative z-10 p-4 sm:p-8 md:p-12 lg:p-16 lg:pl-20 xl:pl-80 min-h-screen lg:min-h-auto flex flex-col justify-center">
            ...
            <div className="mb-12 sm:mb-16 lg:mb-20">
              ...
              <div className="text-white font-['Poppins'] text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl leading-relaxed max-w-[90vw] sm:max-w-[80vw] lg:max-w-[65vw] text-justify opacity-90 px-2 sm:px-0 space-y-3 xs:space-y-4 sm:space-y-6">
                <p>
                  KIIT Entrepreneurship Cell (ECELL) is a nonprofit organisation
                  dedicated to empowering student entrepreneurs under the motto:
                  "Imagine, Innovate, Implement." We see entrepreneurs as
                  pioneers—visionaries who innovate and drive change to build a
                  better future.
                </p>
                <p>
                  Our goal is to nurture and support these changemakers by
                  offering mentorship, exposure, networking opportunities, and
                  resources to help transform ideas into successful ventures. By
                  fostering a vibrant entrepreneurial spirit, we create a strong
                  support system for aspiring business leaders within KIIT.
                </p>
                <p>
                  With over a decade of experience, KIIT ECELL regularly hosts
                  flagship events such as the KIIT E-Summit, Hult Prize KIIT,
                  Internship Camps, Design XP, Speaker Sessions, Star Nights,
                  and numerous workshops and seminars. We also extend our impact
                  beyond campus by organising events and mentoring programs for
                  K12 schools, nurturing innovation from an early age.
                </p>
                <p>
                  Our events consistently attract prominent speakers and
                  distinguished guests, reflecting our commitment to building a
                  dynamic ecosystem where entrepreneurs can thrive. At KIIT
                  ECELL, we welcome passionate minds eager to learn, grow, and
                  lead the future of entrepreneurship.
                </p>
              </div>
            </div>
          </div>
