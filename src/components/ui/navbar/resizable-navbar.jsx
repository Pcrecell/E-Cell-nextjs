...
// import ecell from "../../assets/Images/png/E-Cell Logo.png";
import Image from "next/image";
import { navbar } from "../../../../public/images/image-links";
...
export const NavItems = ({ items = [], className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex flex-row items-center text-sm font-medium space-x-1",
        className
      )}
    >
      {items.map((item, idx) => {
...
export const NavbarLogo = () => {
  ...
  useEffect(() => {
    const updateLogoSize = () => {
      setLogoSize(window.innerWidth < 760 ? 50 : 90);
    };
