...
const PastSpeakers = () => {
  ...
  return (
    <div className="min-h-screen bg-black w-screen flex flex-col items-center justify-start py-40 px-0 overflow-x-hidden">
      {/* Title */}
      <div className="w-full mb-2 mt-4 text-left px-6 md:px-12 lg:pl-24">
        <h1 className="font-poppins font-bold text-[#27ff6a] text-5xl md:text-6xl leading-tight">
          Past<br />Speakers
        </h1>
      ...
      <div className="relative w-full flex flex-col items-center">
        <div className="w-full flex flex-col items-center justify-center relative bg-[#181818] rounded-2xl py-8 px-2 md:px-8 shadow-lg overflow-hidden min-h-[250px] md:min-h-[400px]" >
          {/* Gradient overlay */}
          <div
            className="absolute inset-0 pointer-events-none rounded-2xl z-0"
            style={{
              background: 'linear-gradient(90deg, #000 0%, #181818 60%, #fff 100%)',
              opacity: 0.18,
            }}
          />
          {/* Left Arrow */}
